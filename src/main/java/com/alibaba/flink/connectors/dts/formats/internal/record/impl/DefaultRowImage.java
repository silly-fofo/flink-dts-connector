...
public class DefaultRowImage implements RowImage {
    ...
    public Map<String, Value> toMap(
            Function<String, String> filedNameResolver, Function<Value, Value> valueResolver) {
    ...
    public Pair<RecordField, Value>[] buildFieldValuePairArray(
    ...
    private Pair<RecordField, Value>[] buildAllFieldValuePairArray(
            List<? extends RecordIndexInfo> recordIndexInfoList) {
        if (null == recordIndexInfoList || recordIndexInfoList.isEmpty()) {
            return null;
        }

        Set<RecordField> recordFieldSet =
                recordIndexInfoList.stream()

 ...
 */
@Internal
public class DtsKafkaConsumerThread<T> extends Thread {
                ...
                if (!commitInProgress) {
                    ...
                    if (commitOffsetsAndCallback != null) {
                        ...
                        consumer.commitAsync(
                                ...
                                new DtsKafkaConsumerThread.CommitCallback(commitOffsetsAndCallback.f1));
                    }
                }

...
/** ByteUtil is a tool class to convert bytes to(from) other types. */
public class BytesUtil {
    ...
    public static byte[] toBytes(String value, String encoding)
        ...
        try {
            ...
            LOGGER.warn(
                    "get bytes from from using encoding {} failed, just try to use encoding {} again",
                    realEncoding,
                    mappedEncoding);
    ...
    public static String byteBufferToHexString(ByteBuffer byteBuffer) {
        StringBuilder stringBuilder =
                new StringBuilder(2 * (byteBuffer.limit() - byteBuffer.position()));

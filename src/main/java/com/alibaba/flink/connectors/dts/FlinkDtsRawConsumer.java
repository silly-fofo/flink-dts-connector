...
public class FlinkDtsRawConsumer<T> extends FlinkDtsConsumer<T> {

    protected static final Logger LOG = LoggerFactory.getLogger(FlinkDtsRawConsumer.class);
    ...
    public FlinkDtsRawConsumer setStartFromGroupOffsets() {
        this.flinkKafkaConsumer.setStartFromGroupOffsets();
        return this;
    }
    ...
    public FlinkDtsRawConsumer assignTimestampsAndWatermarks(

...
public final class SwallowException<T extends Closeable> implements AutoCloseable {
    ...
    /** interface without return value. */
    ...
    public static <R> R callAndSwallowException(CalleeFunctionWithReturnValue<R> callee) {
        try {
            ...
            LOGGER.info(
                    "call function {} failed, and swallow exception",
    ...
    public static void callAndSwallowException(CalleeFunctionWithoutReturnValue function) {
        callAndSwallowException(
                (CalleeFunctionWithReturnValue<Void>)
                        () -> {
                            function.call();
                            return null;
                        });
    ...
    public static <R, T extends RuntimeException> R callAndThrowException(
            CalleeFunctionWithReturnValue<R> callee, Function<Exception, T> exceptionSupplier) {
        try {
            return callee.call();
        } catch (Exception e) {
    ...
    public static <T extends RuntimeException> void callAndThrowException(
            CalleeFunctionWithoutReturnValue function, Function<Exception, T> exceptionSupplier) {

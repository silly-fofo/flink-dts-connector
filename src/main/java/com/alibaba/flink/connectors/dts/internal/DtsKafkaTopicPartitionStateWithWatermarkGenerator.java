 ...
 */
@Internal
public final class DtsKafkaTopicPartitionStateWithWatermarkGenerator<T, KPH>
        extends DtsKafkaTopicPartitionState<T, KPH> {
    ...
    public DtsKafkaTopicPartitionStateWithWatermarkGenerator(

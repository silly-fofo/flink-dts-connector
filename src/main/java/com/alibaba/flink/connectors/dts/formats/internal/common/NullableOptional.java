...
/**
 * Copy code from java.util.Optional, the only difference is NullableOptional consider null as a
 * normal value. So the NullableOptional.ofNullable(null).isPresent() should be true.
 */
public final class NullableOptional<T> {
    ...
    public <U> NullableOptional<U> flatMap(Function<? super T, NullableOptional<U>> mapper) {
        ...
        return !this.isPresent()
                ? empty()
                : (NullableOptional) Objects.requireNonNull(mapper.apply(this.value));
    }
    ...
    public boolean equals(Object var1) {
        if (this == var1) {
            ...
            return Objects.equals(this.isPresent, var2.isPresent)
                    && Objects.equals(this.value, var2.value);
        }
    }

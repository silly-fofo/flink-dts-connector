...
/** DefaultRawDataType to represent all data types. */
public class DefaultRawDataType implements RawDataType {
    ...
    public static RawDataType of(
            String dataTypeName, int dataTypeId, boolean isLobType, String encoding) {
    ...
    public static RawDataType copy(RawDataType source, String encoding) {
        return DefaultRawDataType.of(
                source.getTypeName(), source.getTypeId(), source.isLobType(), encoding);
    }
